            ...
            <div className="py-10">
              ...
              <div className="pt-10 w-[55vw] mx-auto">
                ...
                <p>
                  ...
                  <br />
                  This project was a mission to help a travel insurance company
                  to communicate better with potential customers(a.k.a
                  travelers) to improve search traffic by re-designing their
                  website.
                </p>
                <ul className="py-3">
            ...
            <div className="py-10">
              ...
              <div className="pt-10 w-[55vw] mx-auto">
                ...
                <p>
                  ...
                  intuitiveness, and cleanliness by re-imagining how the
                  clinical service should accommodate the patients from the
                ...
                <ul className="py-3">
                  ...
                  <li>
                    - an interactive message or alert for each action or each
                    page
                  </li>
